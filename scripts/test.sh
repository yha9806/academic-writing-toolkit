#!/usr/bin/env bash
# scripts/test.sh — runs 137 regression tests (T2-T5 and T8-T140), including T112-T140 for argument, research-relation, focus-review, clean-room governance, and assistant routing.
...
run_test "T116 strict relation profile accepts a clean packet" test_T116
run_test "T117 strict relation profile rejects a legacy-only packet" test_T117
run_test "T118 strict relation profile separates data from results" test_T118
run_test "T119 strict relation profile proposes an approval-gated focus review" test_T119
run_test "T120 strict relation profile rejects relation cycles" test_T120
run_test "T121 provisional evidence cannot complete a contribution chain" test_T121
run_test "T122 strict relations reject cross-table target mismatches" test_T122
run_test "T123 one focus weakness cannot trigger a focus shift" test_T123
run_test "T124 candidates require a reliable active core-gap relation" test_T124
run_test "T125 contradictory innovation evidence is not positive support" test_T125
run_test "T126 contradicted secondary innovation cannot become a focus candidate" test_T126
run_test "T127 legacy output preserves schema version one" test_T127
run_test "T128 verified counter-evidence uses an allowed relation triple" test_T128
run_test "T129 primary contributions cannot rely on inactive gaps" test_T129
run_test "T130 provisional relation cycles stay advisory" test_T130
run_test "T131 semantic support overlap detects duplicate contributions" test_T131
run_test "T132 strict relation rows require key values" test_T132
run_test "T133 unreliable evidence objects cannot complete a chain" test_T133
run_test "T134 one gap-fit defect cannot count as two focus weaknesses" test_T134
run_test "T135 innovation limits remain traceable counter-signals" test_T135
run_test "T136 a valid focus snapshot satisfies the decision gate" test_T136
run_test "T137 academic writing assistant routes without duplicating governance" test_T137
run_test "T138 contribution focus candidates cannot cross intent boundaries" test_T138
run_test "T139 stale or unrelated focus snapshots fail semantic validation" test_T139
run_test "T140 academic writing assistant locks argument levels and claim licence" test_T140
