#!/usr/bin/env bash
# scripts/test.sh — runs 136 regression tests (T2-T5 and T8-T139), including T112-T139 for argument, research-relation, focus-review, clean-room governance, and assistant routing.
