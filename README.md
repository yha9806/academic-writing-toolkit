...
> distribution — a eight-skill catalogue plus deterministic guard plugins with
...
| **Agent skills** | the same eight-skill catalogue in Claude Code, Codex, or any Agent-Skills host, without the enforcement layer | Advisory (skill text only) |
