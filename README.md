...
| **Review and ship** | `/review`, `/readers`, `/audit`, `/verify-refs`, `/export` | anchored review findings, what a reader panel carried away against the author's intended points, consistency reports, BibTeX checks, Word/ZIP exports |
