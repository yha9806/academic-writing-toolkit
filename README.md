...
<p align="center">
  <img src="docs/assets/readme/awt-product-surfaces.svg" alt="Local agent skills, OpenAI skills-only plugin, and ChatGPT App product surfaces" width="100%">
</p>
...
| **OpenAI skills-only plugin** | installing the same 21-skill catalogue through the OpenAI plugin surface | the local workspace you authorise | normal project files in your clone |
...
make test               # 150 regression tests
...
├── plugins/                 distributable OpenAI skills-only plugin package
...
- [OpenAI skills-only plugin publishing checklist](docs/plugin-publishing-checklist.md)
- [OpenAI skills-only plugin submission packet](docs/openai-codex-plugin-submission.md)
- [Machine-checkable OpenAI reviewer cases](submission/openai/skills-only-submission.json)
- [ChatGPT App publishing guide](docs/chatgpt-app-publishing.md)
- [v0.5.0 release-readiness record](docs/product/v0.5.0-release-readiness.md)
- [v0.4.0 historical release-readiness record](docs/product/v0.4.0-release-readiness.md)
